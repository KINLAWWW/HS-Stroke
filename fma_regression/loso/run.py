...
def main() -> None:
    ...
    if args.model in DEEP_MODELS:
        from fma_regression.loso.core_deep import run_experiment
        ...
        from fma_regression.loso.core_traditional import run_experiment
        ...
        from fma_regression.loso.ridge_core import run_experiment

        run_experiment(
            root_path=FMA_SOURCE_ROOT,
            participants_path=PARTICIPANTS_TSV,
            session_map_path=FMA_SESSIONS_TSV,
            results_dir=RESULTS_ROOT / "fma_regression" / "loso" / args.model,
        )
